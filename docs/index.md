...
./images/					   Images used throughout the guide
./en/                          
     index.md                  Prerequisites and deprovisioning <== Start here!
     chromeosV90orLower.md     Recovery instructions for devices with ChromeOS up to version 90 included
     chromeosV91orHigher.md    Recovery instructions for devices with newer ChromeOS versions
```
...
./images/					   Immagini usate nella guida
./it/                          
     index.md                  Pre-requisiti e deprovisioning <== Iniziare da qui!
